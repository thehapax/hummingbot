...
from hummingbot.market.btse.btse_order_book_message import \
    BTSEOrderBookMessage

_logger = None

# bitfinex source
cdef class BTSEOrderBook(OrderBook):
    ...
    def from_snapshot(cls, snapshot: OrderBookMessage):
        raise NotImplementedError("BTSE order book needs to retain individual order data.")
