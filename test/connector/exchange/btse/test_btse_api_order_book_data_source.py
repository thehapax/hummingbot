...
class BtseAPIOrderBookDataSourceUnitTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.ev_loop: asyncio.BaseEventLoop = asyncio.get_event_loop()
        cls.order_book_data_source: BtseAPIOrderBookDataSource = BtseAPIOrderBookDataSource(["BTC-USDC", "ETH-USDT", "LTC-BTC"])
    ...
    def test_get_tracking_pairs(self):
        ...
        self.assertIsInstance(tracking_pairs["ETH-USDT"], OrderBookTrackerEntry)
